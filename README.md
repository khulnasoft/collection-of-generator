...
<p align="center">
    ...
    <a href="https://pypi.org/project/collection-of/" title="PyPi Version"><img src="https://img.shields.io/pypi/v/collection-of?color=green&style=flat"></a>
    <a href="https://github.com/khulnasoft/collection-of-generator/actions?query=workflow%3Abuild-pipeline" title="Build status"><img src="https://img.shields.io/github/workflow/status/khulnasoft/collection-of-generator/build-pipeline?style=flat"></a>
...
<p align="center">
  ...
  <a href="https://github.com/khulnasoft/collection-of-generator/releases">Changelog</a>
</p>

The collection-of-generator is a CLI tool to generate a markdown page of ranked open-source projects based on a list of projects defined in a `yaml` file. It is integrated with different package managers - such as PyPI, NPM, Conda, and Docker Hub - to automatically collect a variety of project metadata and calculate project-quality scores. It also comes with a GitHub Action workflow for a fully automized update process.

> 🧙‍♂️ Create your own collection-of list in just 3 minutes with [this guide](https://github.com/collection-of-lists/collection-of/blob/main/create-collection-of-list.md).
...
> 🧙‍♂️ If you want to create your own collection-of list, we strongly recommend to follow [this guide](https://github.com/collection-of-lists/collection-of/blob/main/create-collection-of-list.md) instead of setting up collection-of manually. With the guide, it will only take about 3 minutes to get you started. It is already set-up to automatically run the collection-of generator via our GitHub Action and includes other useful template files. Installing the collection-of CLI tool is not required.

1. Install collection-of generator via pip:
    ```bash
    pip install collection-of
    ```
2. Create a `projects.yaml` file based on the [documented structure](#projectsyaml-structure). This file should contain at least one project. For example:
    ```yaml
    projects:
       - name: "collection-of-ml-python"
         github_id: "khulnasoft/collection-of-ml-python"
    ```
3. Run collection-of generator via command-line:
   ```bash
   collection-of generate -g <GITHUB_API_TOKEN> ./projects.yaml
   ```
...
| Type                     | Channel                                              |
| ------------------------ | ------------------------------------------------------ |
| 🚨&nbsp; **Bug Reports**       | <a href="https://github.com/khulnasoft/collection-of-generator/issues?utf8=%E2%9C%93&q=is%3Aopen+is%3Aissue+label%3Abug+sort%3Areactions-%2B1-desc+" title="Open Bug Report"><img src="https://img.shields.io/github/issues/khulnasoft/collection-of-generator/bug.svg?label=bug"></a>                                 |
| 🎁&nbsp; **Feature Requests**  | <a href="https://github.com/khulnasoft/collection-of-generator/issues?q=is%3Aopen+is%3Aissue+label%3Afeature+sort%3Areactions-%2B1-desc" title="Open Feature Request"><img src="https://img.shields.io/github/issues/khulnasoft/collection-of-generator/feature.svg?label=feature%20request"></a>                                 |
| 👩‍💻&nbsp; **Usage Questions**   |  <a href="https://github.com/khulnasoft/collection-of-generator/issues?q=is%3Aopen+is%3Aissue+label%3Asupport+sort%3Areactions-%2B1-desc" title="Open Support Request"> <img src="https://img.shields.io/github/issues/khulnasoft/collection-of-generator/support.svg?label=support%20request"></a> <a href="https://gitter.im/khulnasoft/collection-of" title="Chat on Gitter"><img src="https://badges.gitter.im/khulnasoft/collection-of.svg"></a> |
| 📢&nbsp; **Announcements** | <a href="https://gitter.im/khulnasoft/collection-of" title="Chat on Gitter"><img src="https://badges.gitter.im/khulnasoft/collection-of.svg"></a> <a href="https://collectionoflists.substack.com/subscribe" title="Subscribe for updates"><img src="http://bit.ly/2Md9rxM"></a> <a href="https://twitter.com/collection_of_lists" title="Collection-of on Twitter"><img src="https://img.shields.io/twitter/follow/collection_of_lists.svg?style=social&label=Follow"> |
| ❓&nbsp; **Other Requests** | <a href="mailto:collection-of@khulnasoft.com" title="Email collection-of team"><img src="https://img.shields.io/badge/email-collection of-green?logo=mail.ru&logoColor=white"></a> |
...
The collection-of generator is a CLI tool to generate a markdown page from a list of projects configured in a `yaml` file. The documentation sections below will provide information on the [`projects.yaml` structure](#projectsyaml-structure), on its different sections ([projects](#projects), [labels](#labels), [categories](#categories) & [configuration]((#configuration))), on some of the collection-of features (e.g. [project-quality score](#project-quality-score) & [trending projects](#trending-projects)), and instructions on how to run the markdown generation [via the command-line interface](#generation-via-cli) or [via GitHub Actions](#generation-via-github-action).

### `projects.yaml` Structure

The `projects.yaml` file has the following structure:

- `configurations` (optional): Can be used to overwrite the default configuration of the collection-of list. More information in the [configuration section](#configuration).
...
categories:
  - category: "data-engineering"
    ...
    subtitle: "Collection-of lists about machine learning, data engineering, data science, or other topics related to big data."

# Optional: add labels
labels:
  - label: "python"
    image: "https://www.python.org/static/favicon.ico"
    description: "Collection-of list with Python projects"
...
projects:
  ...
  - name: "Collection-of Generator"
    pypi_id: "collection-of"
    github_id: "khulnasoft/collection-of-generator"
  # Link to another project collection:
  - name: "Collection-of Overview"
    homepage: "https://collection-of.org"
    resource: True
...
![Projects Example](./docs/images/collection-of-generated-projects-framed.png)

Every project can also be expanded to show additional project information (by clicking on the project), for example:

![Project Body Example](./docs/images/collection-of-project-body-framed.png)
...
<table>
    ...
    <tr>
        ...
        <td>Name of the project. This name is required to be unique on the collection-of list.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>GitHub ID of the project based on user or organization  and the repository name, e.g. <code>khulnasoft/collection-of-generator</code>. If the project is hosted on GitLab, please use the <code>gitlab_id</code> property.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>If <code>True</code>, the project will be marked as a resource. Resources are not ranked and will always be shown on top of the category. You can use this to link to another collection-of list section or website that contains additional projects.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>GitLab ID of the project based on user or organization  and the repository name, e.g. <code>khulnasoft/collection-of-generator</code>.</td>
    </tr>
</table>

While you can theoretically overwrite all project metadata, we suggest to only set the properties which the collection-of generator is not able to find on GitHub or the configured package managers. There are also other undocumented properties, but for most projects those properties should not be overwritten.
...
A category allows to add additional structure to the collection-of list by grouping related projects into a shared category. Thereby, every project is grouped into exactly one category. If no category is provided with the project metadata, the project will be categorized into `Others`.
...
![Category Example](./docs/images/collection-of-category-example-framed.png)
...
![Label Example](./docs/images/collection-of-label-example-framed.png)
...
Many aspects of the collection-of list can be configured. Since most default values are selected to support the widest range of different lists, changing the default configuration is not required for most cases.
...
> To use the CLI, you need to have the collection-of generator installed via pip: 
> `pip install collection-of`

```bash
collection-of generate [OPTIONS] PATH
```

Generates a collection-of markdown page from a `yaml` file.

**Arguments**:

* `PATH`: Path to the `yaml` file containing the collection-of metadata (e.g. `./projects.yaml`).
...
> 🧙‍♂️ If you want to create your own collection-of list, we strongly recommend to follow [this guide](https://github.com/collection-of-lists/collection-of/blob/main/create-collection-of-list.md). With the guide, it will only take about 3 minutes to get you started. It already includes this GitHub Action and some other useful template files. Further manual steps for setting up the GitHub Action are not required.

The [collection-of-update-action](https://github.com/marketplace/actions/collection-of-update-action) makes it very easy to set-up automated scheduled updates for your collection-of markdown page. Please refer to the [collection-of-update-action documentation](https://github.com/marketplace/actions/collection-of-update-action) for more detailed information about the GitHub Action and the workflow.

### Generation via Python API

> _Usage of the Python API is not well documented yet and currently not recommended._

The collection-of generator can also be used and integrated via its Python API. The full Python API documentation can be found [here](https://github.com/khulnasoft/collection-of-generator/blob/main/docs/README.md).

### Updating Collection-of Generator
...
GitHub only renders the first 512 kb of the main `README.md` file and will cut off the rendered version as soon as it has processed the first 512 kb of the raw markdown content. The rendering is only cut off when viewing the readme on the main repo page. If you directly select the `README.md` file, it will render in its entirety. To mitigate this issue, we optimized the markdown generation to require the minimum amount of characters. However, if you have a very large list of projects (more than 800), you might reach the 512 kb limit (check the file size of the generated `README.md` file). In this case, we suggest to extract some of the categories or projects into smaller collection-of lists.

</details>

## Contribution

- Pull requests are encouraged and always welcome. Read our [contribution guidelines](https://github.com/khulnasoft/collection-of-generator/tree/main/CONTRIBUTING.md) and check out [help-wanted](https://github.com/khulnasoft/collection-of-generator/issues?utf8=%E2%9C%93&q=is%3Aopen+is%3Aissue+label%3A"help+wanted"+sort%3Areactions-%2B1-desc+) issues.
- Submit GitHub issues for any [feature request and enhancement](https://github.com/khulnasoft/collection-of-generator/issues/new?assignees=&labels=feature&template=02_feature-request.md&title=), [bugs](https://github.com/khulnasoft/collection-of-generator/issues/new?assignees=&labels=bug&template=01_bug-report.md&title=), or [documentation](https://github.com/khulnasoft/collection-of-generator/issues/new?assignees=&labels=documentation&template=03_documentation.md&title=) problems.
- By participating in this project, you agree to abide by its [Code of Conduct](https://github.com/khulnasoft/collection-of-generator/blob/main/.github/CODE_OF_CONDUCT.md).
...
Refer to our [contribution guides](https://github.com/khulnasoft/collection-of-generator/blob/main/CONTRIBUTING.md#development-instructions) for more detailed information on our build scripts and development process.
