...
from collection_of import default_config, integrations, utils
from src.collection_of.generators.collection_generator import BaseGenerator
from collection_of.integrations import github_integration
from collection_of.license import get_license
...
def generate_changes_md(projects: list, config: Dict, labels: list) -> str:
    ...
    if added_projects:
        ...
        markdown += "_Projects that were recently added to this collection-of list._\n\n"
